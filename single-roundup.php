...
.rnd-eyebrow{display:flex;align-items:center;gap:8px;font-size:11px;font-weight:500;color:#E8401C;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:14px;}
